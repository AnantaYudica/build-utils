...
function(set_variables)
    ...
    if("${set_variables_TEST_SOURCE_DIR}" STREQUAL "")
        get_filename_component(l_test_source_dir "${BUILD_UTILS_TEST_BASE_DIR}/build_utils" ABSOLUTE)
    else()
        get_filename_component(l_test_source_dir "${set_variables_TEST_SOURCE_DIR}" ABSOLUTE)
    endif()

    if (EXISTS "${l_test_source_dir}")
        set(BUILD_UTILS_TEST_SOURCE_DIR ${l_test_source_dir} CACHE PATH "test utils directory" FORCE)
