...
function(set_variables)
    cmake_parse_arguments(set_variables "" 
        "MAIN_SOURCE_DIR;INCLUDE_DIR;TEST_DIR;TEST_UTILS_DIR;TEST_BUILD_UTILS_DIR" "" ${ARGN}) 

    set(l_main_source_dir "")
    get_filename_component(l_main_source_dir "${set_variables_MAIN_SOURCE_DIR}" ABSOLUTE)

    if (EXISTS "${l_main_source_dir}")
        set(MAIN_SOURCE_DIR ${l_main_source_dir} CACHE PATH "project cmake directory" FORCE)
    elseif(NOT EXISTS "${l_main_source_dir}")
        set(MAIN_SOURCE_DIR ${CMAKE_SOURCE_DIR} CACHE PATH "project cmake directory" FORCE)
    else()
        message(FATAL_ERROR "variable \"MAIN_SOURCE_DIR\"" )
    endif()
    ...
    elseif(NOT EXISTS "${l_include_dir}")
        get_filename_component(l_include_dir "${MAIN_SOURCE_DIR}/../include" ABSOLUTE)
        set(INCLUDE_DIR "${l_include_dir}" CACHE PATH "include directory" FORCE)
    else()
    ...
    elseif(NOT EXISTS "${l_test_dir}")
        get_filename_component(l_test_dir "${MAIN_SOURCE_DIR}/test" ABSOLUTE)
        set(TEST_DIR "${l_test_dir}" CACHE PATH "test directory" FORCE)
    else()
    ...
    include(${MAIN_SOURCE_DIR}/include_build_util.cmake)
