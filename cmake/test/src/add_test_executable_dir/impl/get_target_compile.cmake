function(add_test_executable_dir_get_target_compile out_list_def out_list_option)
    ...
    if (args_UPPER)
        string(TOUPPER "${add_test_executable_dir_get_target_compile_DEFAULT_LIST_DEF}" 
            default_list_def)
        string(TOUPPER "${add_test_executable_dir_get_target_compile_DEFAULT_LIST_OPTION}" 
            default_list_option)
    else()
        set(default_list_def 
            ${add_test_executable_dir_get_target_compile_DEFAULT_LIST_DEF})
