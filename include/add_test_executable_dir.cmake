    ...
    foreach(it ${list_file})
        ...
        if (ok)
            if(is_directory AND (is_recursive))
                ...
                if (is_output_target_compile_option_arg)
            ...
            elseif(NOT is_directory)
                ...
                if (ok)
                    ...
                    add_test_executable_dir_get_target_include(target_list_include_dir_arg
                        DEFAULT_LIST_ARG ${list_include_dir_arg}
                        TARGET_NAME ${target_name} TARGET_DIR ${prefix_dir}
                        BASE_DIR ${base_dir} PATH ${it} RELATIVE_PATH ${relative_path}
                        FILENAME ${filename} NAME ${src_name} TAG ${src_tag} EXT ${src_ext} 
                        CURR_DIR ${dir} RELATIVE_CURR_DIR ${relative_dir} 
                    ...
                    add_test_executable_dir_get_target_compile(
                        ...
                        DEFAULT_LIST_OPTION_ARG ${list_compile_option_arg}
                        TARGET_NAME ${target_name} TARGET_DIR ${prefix_dir}
                        BASE_DIR ${base_dir} PATH ${it} RELATIVE_PATH ${relative_path} 
                        FILENAME ${filename} NAME ${src_name} TAG ${src_tag} EXT ${src_ext} 
                        CURR_DIR ${dir} RELATIVE_CURR_DIR ${relative_dir} 
                    ...
                    if (NOT "${target_name}" STREQUAL "")
                        ...
                        if (NOT "${target_list_compile_option_arg}" STREQUAL "")
                            ...
                            if (is_output_target_compile_option_arg)
                                list(APPEND foreach_list_target_compile_option_arg 
                                    ${target_list_compile_option_arg})
                            endif()
...
function(add_test_executable_dir dir)
    ...
    if (enable_output_target_compile_option_arg)
        set(${add_test_executable_dir_LIST_TARGET_COMPILE_OPTION_ARG} 
