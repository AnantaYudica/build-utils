function(get_test_source_dir_condition path output)
    ...
    string(CONCAT one_options_args "HEADER_CONDITION;GET_NAME;GET_TAG;TAG_CONDITION;TAG_DELIMITER"
        ...
        ";SRC_FILENAME;SRC_NAME;SRC_TAG;SRC_EXT;SRC_DIR;SRC_RELATIVE_DIR")
    cmake_parse_arguments(args "" 
        "${one_options_args}" 
        "LIST_TAG;HEADER_CONDITION_ARGS" ${get_test_source_dir_condition_ARGS})
    ...
    if(NOT "${args_SRC_DIR}" STREQUAL "")
        list(APPEND call_args "SRC_DIR" ${args_SRC_DIR})
    endif()

    if(NOT "${args_SRC_RELATIVE_DIR}" STREQUAL "")
        list(APPEND call_args "SRC_RELATIVE_DIR" ${args_SRC_RELATIVE_DIR})
    endif()
