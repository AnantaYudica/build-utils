...
function(upper_str input output)
    ...
    if ("${EMPTY}${upper_str_INDEX}" STREQUAL "${EMPTY}")
        set(index 0)
    elseif(NOT "${EMPTY}${upper_str_INDEX}" STREQUAL "${EMPTY}")
        set(index ${upper_str_INDEX})
    else()
        message(ERROR "ERROR at INDEX arg")
    endif()

    if ("${EMPTY}${upper_str_LENGTH}" STREQUAL "${EMPTY}")
        math(EXPR length "${input_length}-${index}")
    elseif (NOT "${EMPTY}${upper_str_LENGTH}" STREQUAL "${EMPTY}")
    ...
    if(NOT "${EMPTY}${upper}" STREQUAL "${EMPTY}")
